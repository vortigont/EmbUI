...
class EmbUI
{
  ...
  public:
    ...
    mqttCallback onConnectCallBack;
#endif
...
#ifdef EMBUI_MQTT
    // MQTT
    bool isMQTTconected() const { return mqttClient.connected(); }
  ...
  private:
    ...
    // need to keep literal params in obj and pass by reference
    String mqtt_topic;
    ...
    // Task that will make reconnect attemtps to mqtt
    ...
    void connectToMqtt();
    void onMqttConnect();
    //static void _onMqttConnected(bool sessionPresent);
